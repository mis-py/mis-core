...
class UserGroup(Model):
    ...
    app = fields.ForeignKeyField('models.App', related_name='groups', null=True)
...
class RestrictedObject(Model):
    ...
    object_app = fields.ForeignKeyField('models.App', related_name='restricted_objects', null=True)

    allowed_groups: fields.ManyToManyRelation[UserGroup]
...
class RestrictedObjectMixin:
    ...
    @resolve_relation  # noqa
    async def allow(self, group: UserGroup):
